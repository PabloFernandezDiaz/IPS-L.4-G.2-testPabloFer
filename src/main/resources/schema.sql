...
CREATE TABLE COLEGIADO (
    COLEGIADO_ID VARCHAR(36) PRIMARY KEY NOT NULL,
    N_COLEGIADO VARCHAR(32), 
    PRECOLEG BOOLEAN NOT NULL ,
    ESTADO VARCHAR(15) CHECK (ESTADO IN ('PENDIENTE','ACEPTADO')) NOT NULL, 
    ...
    TITULACION VARCHAR(32) NOT NULL,
    CENTRO VARCHAR(32) NOT NULL,
    YEAR INT NOT NULL, 
